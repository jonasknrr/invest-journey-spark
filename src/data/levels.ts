...
export const levels: Level[] = [
  ...
  },
  {
    ...
    progress: 42,
    subLevels: [
      { id: 'a1', title: 'What are Stocks?', description: 'Imagine buying a piece of your favourite company', status: 'completed', duration: '3 Min' },
      { id: 'a2', title: 'How is the stock price determined?', description: 'Why stocks grow long-term', status: 'completed', duration: '4 Min' },
      { id: 'a3', title: 'Risk and Volatility', description: 'Why fluctuations are normal', status: 'completed', duration: '3 Min' },
      { id: 'a4', title: 'Dividends', description: 'Earn money just by holding', status: 'completed', duration: '3 Min' },
      { id: 'a5', title: 'Diversification', description: 'The smart way to spread risk', status: 'completed', duration: '4 Min' },
      { id: 'a6', title: 'Long-term Thinking', description: 'Time is your best friend', status: 'completed', duration: '3 Min' },
