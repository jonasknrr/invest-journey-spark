...
export const levels: Level[] = [
  ...
  },
  {
    ...
    subtitle: 'Gold, Silver & Safe Havens',
    iconName: 'Diamond',
    colorKey: 'metals',
    colorVar: '--level-metals',
    status: 'locked',
    progress: 0,
    subLevels: [
      { id: 'g1', title: 'Why Precious Metals?', description: 'Gold, silver & the safe haven concept', status: 'locked', duration: '3 Min' },
      { id: 'g2', title: 'Physical vs Digital', description: 'Bars in the vault or ETF in the portfolio?', status: 'locked', duration: '3 Min' },
      { id: 'g3', title: 'Precious Metals vs Stocks', description: 'When does gold make more sense than stocks?', status: 'locked', duration: '4 Min' },
    ],
  },
  {
    id: 'realestate',
