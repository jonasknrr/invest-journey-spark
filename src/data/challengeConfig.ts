...
export const chapterConfigs: ChapterConfig[] = [
  ...
  },
  {
    ...
    scenario: {
      ...
      description:
        'You have a budget of 10,000 CHF.\n1. You need a liquid emergency fund of 1,000 CHF (available immediately).\n2. You plan to buy a car in exactly 3 years, requiring a safe 2,000 CHF.\n3. The remaining 7,000 CHF is for your long-term wealth building.',
    },
  },
];
